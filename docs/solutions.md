...
This file provides PostgreSQL solutions for each question in `docs/questions.md`.

## 1. Adding a New Product

```sql
INSERT INTO products (product_id, name, price, category)
VALUES (101, 'Bluetooth Speaker X1', 79.99, 'Electronics');
```
...
VALUES (101, 'Amina Yusuf', 'amina.yusuf101@example.com');
```
...
```sql
UPDATE customers
SET email = 'amina.yusuf.updated@example.com'
...
SELECT *
FROM orders
WHERE order_date BETWEEN DATE '2026-01-10' AND DATE '2026-02-10'
ORDER BY order_date;
```
